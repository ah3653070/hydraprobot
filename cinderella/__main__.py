...
if START_IMG is None:
    img = "https://telegra.ph/file/c369416053fbab65e4440.jpg"
...
def send_start(bot, update):
    ...
    keyboard = [[InlineKeyboardButton(text="💖CONTACT CREATOR💖",url="http://t.me/Eva_Elffie"),InlineKeyboardButton(text="💖DEVELOPER💖",url="https://t.me/united_bots")]]
    keyboard += [[InlineKeyboardButton(text="💖JOIN SUPPORT💖",url="http://t.me/eva_gbanlog"),InlineKeyboardButton(text="💖OUR COMMUNITY💖",url="http://t.me/zyrusbots")]]
    keyboard += [[InlineKeyboardButton(text="💖HELP💖",callback_data="help_back"),InlineKeyboardButton(text="💖CONNECT💖",callback_data="main_connect")]]
